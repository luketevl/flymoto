 ...
 */
class Veiculos_Temp extends DataMapper {
...
*/
	...
	*/
	public function salvar($_data){
		//$this-> = new Veiculos_Temp();
//		echo "<pre>"; print_r(				array_merge((array)$n->stored, $_data)); "</pre>";
		//$n->dt_criacao = 		date("Y-m-d H:i:s");
		//$this->id_vei       = $_data['id_vei'];
		$this->placa_vei      = $_data['placa_vei'];
		$this->ano_vei        = $_data['ano_vei'];
		$this->mod_vei        = $_data['mod_vei'];
		$this->fabricante_vei = $_data['fabricante_vei'];
