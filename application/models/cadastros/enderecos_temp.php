 ...
 */
class Enderecos_Temp extends DataMapper {
...
*/
	...
	*/
	...
	//	$this-> = new Enderecos_Temp();
//		echo "<pre>"; print_r(				array_merge((array)$n->stored, $_data)); "</pre>";
		//$n->dt_criacao = 		date("Y-m-d H:i:s");
		$this->id_ent                  = $_data['id_ent'];
		$this->id_end_temp             = $_data['id_end_temp'];
		$this->rua_end_temp            = $_data['rua_end_temp'];
		$this->num_end_temp            = $_data['num_end_temp'];
		$this->complemento_end_temp    = $_data['complemento_end_temp'];
		$this->bairro_end_temp         = $_data['bairro_end_temp'];
		$this->cidade_end_temp         = $_data['cidade_end_temp'];
		$this->cep_end_temp            = $_data['cep_end_temp'];
		$this->id_ent                  = $_data['id_ent'];
		$this->save();
	}
}
